...
[file a bug](https://github.com/canonical/digest-squid-auth-helper/issues) to provide constructive feedback or suggestions.

See [CONTRIBUTING.md](https://github.com/canonical/digest-squid-auth-helper/blob/main/CONTRIBUTING.md)
