...
This document explains the processes and practices recommended for contributing enhancements to the Digest Squid Auth Helper Operator.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/digest-squid-auth-helper/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/digest-squid-auth-helper)
...
Canonical welcomes contributions to the Digest Squid Auth Helper Operator. Please check out our
...
```
git clone https://github.com/canonical/digest-squid-auth-helper
```
...
OCI image for the Digest Squid Auth Helper app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./digest-squid-auth-helper*.charm 
```
